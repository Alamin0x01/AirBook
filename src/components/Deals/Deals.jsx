  ...
  return (
    <div className="mt-10 lg:max-w-6xl lg:mx-auto p-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        <div className="card card-side bg-white drop-shadow-2xl">
          <figure className="">
            <img src={img1} alt="Movie" />
          </figure>
          <div className="card-body bg-white">
            <h2 className="text-[#09182E] font-medium text-xs">
              With bkash payment only
            </h2>
            <p className="text-[#006CE4] text-base font-semibold">
              up to 14% discount on the base fare of domestic flights
            </p>
          </div>
        </div>
        <div className="card card-side drop-shadow-2xl bg-white">
          <figure>
        ...
        <div className="card card-side drop-shadow-2xl bg-white">
          <figure>
            <img className="" src={img3} alt="Movie" />
          </figure>
          <div className="card-body">
            <h2 className="text-[#09182E] font-medium text-xs">
              With bkash payment only
