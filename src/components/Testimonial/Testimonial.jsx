        ...
        <div className=" py-14 bg-[#006CE4] flex gap-4">
          <div className="lg:max-w-6xl lg:mx-auto  flex gap-4">
            ...
            <div className="card lg:card-side bg-base-100">
              <figure>
                <img className="h-full rounded-r-xl" src={img2} alt="Album" />
              </figure>
              <div className="card-body bg-white">
                <div>
                  <h2 className="text-sm font-normal pb-3 text-[#09182E]">
                    &#34;Unforgettable journeys with John and Sarah! Their
                    travel expertise turned our dreams into reality. Can not
                    wait to explore with them again!&#34;
                  </h2>
